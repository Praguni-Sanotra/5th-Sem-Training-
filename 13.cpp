...
int main(){
    ...
    for(int y : b) //Shows that for each loop will work according to size of array and not according to number 
    // of elements initialized in the array
    cout << y << endl;
    cout << endl;
...
float d[6] = {12.5 , 82.4 , 43.6 , 4.54 , 77.48 , 84.88}; //No need to know the type of array
